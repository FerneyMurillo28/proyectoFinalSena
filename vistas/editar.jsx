...
function EditarDatos({navigation}){
  ...
  >
    <View style={styles.container}>
      ...
      >
        <Text style={styles.espaciado}>Ingresa el nuevo titulo de la publicación</Text>
        <TextInput style={styles.cajas1} placeholder="Título" onChangeText={(value) => handleChangeText('titulo', value)}></TextInput>
        <Text style={styles.espaciado}>Ingresa el nuevo contenido de la publicación</Text>
